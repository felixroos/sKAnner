...
const PORT = process.env.RECEIVER_PORT || 4321;
...
const requestHandler = (req, res) => {
  ...
  if (code.length === 8 && code.startsWith("00000")) {
    ...
    return res.writeHead(200, { "Content-Type": "text/plain" }).end("number");
  }
  ...
  if (!code) {
    ...
    return res.writeHead(200, { "Content-Type": "text/plain" }).end("hi");
  }
  ...
  if (!action) {
    ...
    return res.writeHead(200, { "Content-Type": "text/plain" }).end("hey");
  }
...
\\$$$$$$\\  $$  $$<   $$  __$$ |$$ |  $$ |$$ |  $$ |$$$$$$$$ |$$ |  \\__|
 \\____$$\\ $$ |\\$$\\  $$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |      
$$$$$$$  |$$ | \\$$\\ $$ |  $$ |$$ |  $$ |$$ |  $$ |\\$$$$$$$\\ $$ |      
\\_______/ \\__|  \\__|\\__|  \\__|\\__|  \\__|\\__|  \\__| \\_______|\\__|   
